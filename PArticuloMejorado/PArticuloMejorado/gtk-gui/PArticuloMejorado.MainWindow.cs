...
namespace PArticuloMejorado
{
	public partial class MainWindow
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget PArticuloMejorado.MainWindow
			this.UIManager = new global::Gtk.UIManager ();
			global::Gtk.ActionGroup w1 = new global::Gtk.ActionGroup ("Nuevo grupo de acciones");
			...
			this.Name = "PArticuloMejorado.MainWindow";
			this.Title = global::Mono.Unix.Catalog.GetString ("PArticulo Mejorado - Kevin Sotomayor");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Container child PArticuloMejorado.MainWindow.Gtk.Container+ContainerChild
			this.vbox1 = new global::Gtk.VBox ();
			this.vbox1.Name = "vbox1";
			this.vbox1.Spacing = 6;
			// Container child vbox1.Gtk.Box+BoxChild
			this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar'><toolitem name='editAction' action='editAction'/><toolitem name='refreshAction' action='refreshAction'/><toolitem name='addAction' action='addAction'/><toolitem name='clearAction' action='clearAction'/></toolbar></ui>");
